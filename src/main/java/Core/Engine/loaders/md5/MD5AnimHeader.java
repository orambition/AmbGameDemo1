...
//用于解析md5anim文件中头文件的专属类，与MD5modelHeader类相似
import java.util.List;

public class MD5AnimHeader {
    private String version;
    private String commandLine;
    private int numFrames;//帧的数量
    private int numJoints;//涉及的关节数
    private int frameRate;//每秒多少帧
    private int numAnimatedComponents;//每帧中的元素数量，关节X6（位置x，y，z+方向x，y，z）。
