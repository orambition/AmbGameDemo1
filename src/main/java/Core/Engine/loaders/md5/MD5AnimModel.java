...
//用于从MD5anim文件中加载动作信息，与MD5model类似
...
public class MD5AnimModel {
    private MD5AnimHeader header;//头文件
    private MD5Hierarchy hierarchy;//骨骼信息
    private MD5BoundInfo boundInfo;//包围盒信息
    private MD5BaseFrame baseFrame;//基础帧
    private List<MD5Frame> frames;//关键帧
